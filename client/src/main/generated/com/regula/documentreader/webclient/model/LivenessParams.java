...
public class LivenessParams {
  ...
  public static final String SERIALIZED_NAME_CHECK_GEOMETRY = "checkGeometry";

  @SerializedName(SERIALIZED_NAME_CHECK_GEOMETRY)
  @javax.annotation.Nullable
  ...
  public LivenessParams checkGeometry(@javax.annotation.Nullable Boolean checkGeometry) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getCheckGeometry() {
    return checkGeometry;
  }

  public void setCheckGeometry(@javax.annotation.Nullable Boolean checkGeometry) {
    this.checkGeometry = checkGeometry;
  }
