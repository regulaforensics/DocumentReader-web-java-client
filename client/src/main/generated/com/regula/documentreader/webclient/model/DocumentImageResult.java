...
public class DocumentImageResult {
  ...
  public DocumentImageResult rawImageContainer(
      @javax.annotation.Nonnull ImageData rawImageContainer) {
  ...
  public DocumentImageResult bufLength(@javax.annotation.Nullable Integer bufLength) {
  ...
  public DocumentImageResult light(@javax.annotation.Nullable Integer light) {
    this.light = light;
    return this;
  }
  ...
  public DocumentImageResult listIdx(@javax.annotation.Nullable Integer listIdx) {
  ...
  public DocumentImageResult pageIdx(@javax.annotation.Nullable Integer pageIdx) {
  ...
  public DocumentImageResult resultType(@javax.annotation.Nonnull Integer resultType) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentImageResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DocumentImageResult.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in DocumentImageResult is not found in the empty JSON string",
                DocumentImageResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DocumentImageResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `DocumentImageResult` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : DocumentImageResult.openapiRequiredFields) {
    ...
    // validate the required field `RawImageContainer`
    ImageData.validateJsonElement(jsonObj.get("RawImageContainer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!DocumentImageResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'DocumentImageResult' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<DocumentImageResult> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(DocumentImageResult.class));

      return (TypeAdapter<T>)
          new TypeAdapter<DocumentImageResult>() {
            @Override
            public void write(JsonWriter out, DocumentImageResult value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public DocumentImageResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentImageResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentImageResult
   * @throws IOException if the JSON string is invalid with respect to DocumentImageResult
   */
  public static DocumentImageResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentImageResult.class);
  }

  /**
   * Convert an instance of DocumentImageResult to an JSON string
   *
   * @return JSON string
   */
