...
public class ProcessParams {
  ...
  /**
   * If it is set to true, the Surname and GivenNames fields from the MRZ will be divided into the
   * ft_First_Name, ft_Second_Name, ft_Third_Name, ft_Fourth_Name, ft_Last_Name fields
   *
   * @return splitNames
   */
  @javax.annotation.Nullable
  ...
  public ProcessParams withProcessAuth(Boolean processAuth) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getProcessAuth() {
    return processAuth;
  }

  public void setProcessAuth(Boolean processAuth) {
    this.processAuth = processAuth;
  }
