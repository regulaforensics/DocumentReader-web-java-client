...
public class GraphicFieldRfidItem {
  ...
  public GraphicFieldRfidItem() {}

  public GraphicFieldRfidItem rfIDOriginDG(
  ...
  public GraphicFieldRfidItem rfIDOriginDGTag(@javax.annotation.Nonnull Integer rfIDOriginDGTag) {
  ...
  public GraphicFieldRfidItem rfIDOriginTagEntry(
      @javax.annotation.Nonnull Integer rfIDOriginTagEntry) {
  ...
  public GraphicFieldRfidItem rfIDOriginEntryView(
  ...
  public boolean equals(Object o) {
    ...
    GraphicFieldRfidItem graphicFieldRfidItem = (GraphicFieldRfidItem) o;
    return Objects.equals(this.rfIDOriginDG, graphicFieldRfidItem.rfIDOriginDG)
        && Objects.equals(this.rfIDOriginDGTag, graphicFieldRfidItem.rfIDOriginDGTag)
        && Objects.equals(this.rfIDOriginTagEntry, graphicFieldRfidItem.rfIDOriginTagEntry)
        && Objects.equals(this.rfIDOriginEntryView, graphicFieldRfidItem.rfIDOriginEntryView);
  }
  ...
  public String toString() {
    ...
    sb.append("class GraphicFieldRfidItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphicFieldRfidItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GraphicFieldRfidItem.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GraphicFieldRfidItem is not found in the empty JSON string",
                GraphicFieldRfidItem.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GraphicFieldRfidItem.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GraphicFieldRfidItem` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : GraphicFieldRfidItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GraphicFieldRfidItem.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GraphicFieldRfidItem' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<GraphicFieldRfidItem> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(GraphicFieldRfidItem.class));

      return (TypeAdapter<T>)
          new TypeAdapter<GraphicFieldRfidItem>() {
            @Override
            public void write(JsonWriter out, GraphicFieldRfidItem value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public GraphicFieldRfidItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GraphicFieldRfidItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphicFieldRfidItem
   * @throws IOException if the JSON string is invalid with respect to GraphicFieldRfidItem
   */
  public static GraphicFieldRfidItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphicFieldRfidItem.class);
  }

  /**
   * Convert an instance of GraphicFieldRfidItem to an JSON string
   *
   * @return JSON string
   */
