...
public class TextFieldType {
  ...
  public static final int RM_FROM = 651;

  /** DL class code RM valid notes */
  public static final int RM_NOTES = 652;

  /** DL class code RM valid to */
  public static final int RM_TO = 653;

  /** DL class code PW valid from */
  public static final int PW_FROM = 654;

  /** DL class code PW valid notes */
  public static final int PW_NOTES = 655;

  /** DL class code PW valid to */
  public static final int PW_TO = 656;
}
