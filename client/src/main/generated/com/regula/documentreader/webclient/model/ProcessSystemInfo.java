...
public class ProcessSystemInfo {
  ...
  public ProcessSystemInfo() {}

  public ProcessSystemInfo license(@javax.annotation.Nullable String license) {
  ...
  public ProcessSystemInfo recaptchaToken(@javax.annotation.Nullable String recaptchaToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProcessSystemInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProcessSystemInfo.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ProcessSystemInfo` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ProcessSystemInfo.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ProcessSystemInfo' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ProcessSystemInfo> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ProcessSystemInfo.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ProcessSystemInfo>() {
            @Override
            public void write(JsonWriter out, ProcessSystemInfo value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public ProcessSystemInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProcessSystemInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProcessSystemInfo
   * @throws IOException if the JSON string is invalid with respect to ProcessSystemInfo
   */
  public static ProcessSystemInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProcessSystemInfo.class);
  }

  /**
   * Convert an instance of ProcessSystemInfo to an JSON string
   *
   * @return JSON string
   */
