...
import com.regula.documentreader.webclient.model.DeviceInfo2;
...
public class HealthcheckApi {
   ...
   * </table>
   */
  public DeviceInfo2 healthz(String xRequestID) throws ApiException {
    ApiResponse<DeviceInfo2> localVarResp = healthzWithHttpInfo(xRequestID);
   ...
   *
   * @param xRequestID (optional)
   * @return ApiResponse&lt;DeviceInfo2&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   * @http.response.details
   *     <table summary="Response Details" border="1">
   ...
   * </table>
   */
  public ApiResponse<DeviceInfo2> healthzWithHttpInfo(String xRequestID) throws ApiException {
    okhttp3.Call localVarCall = healthzValidateBeforeCall(xRequestID, null);
    Type localVarReturnType = new TypeToken<DeviceInfo2>() {}.getType();
   ...
   * </table>
   */
  public okhttp3.Call healthzAsync(String xRequestID, final ApiCallback<DeviceInfo2> _callback)
      throws ApiException {
