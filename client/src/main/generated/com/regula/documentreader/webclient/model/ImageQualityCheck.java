...
public class ImageQualityCheck {
  ...
  public ImageQualityCheck withType(ImageQualityCheckType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(ImageQualityCheckType type) {
    this.type = type;
  }
  ...
  public ImageQualityCheck withAreas(List<AreaArray> areas) {
    this.areas = areas;
    return this;
  }

  public ImageQualityCheck addAreasItem(AreaArray areasItem) {
    if (this.areas == null) {
      this.areas = new ArrayList<AreaArray>();
    }
   ...
   */
  @javax.annotation.Nullable
  public List<AreaArray> getAreas() {
    return areas;
  }

  public void setAreas(List<AreaArray> areas) {
    this.areas = areas;
  }

  public ImageQualityCheck withMean(Numbers mean) {
    this.mean = mean;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Numbers getMean() {
    return mean;
  }

  public void setMean(Numbers mean) {
    this.mean = mean;
  }

  public ImageQualityCheck withStdDev(Numbers stdDev) {
    this.stdDev = stdDev;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Numbers getStdDev() {
    return stdDev;
  }

  public void setStdDev(Numbers stdDev) {
    this.stdDev = stdDev;
  }
