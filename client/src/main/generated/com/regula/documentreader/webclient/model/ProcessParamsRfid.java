...
public class ProcessParamsRfid {
        ...
        @SerializedName(SERIALIZED_NAME_PA_SENSITIVE_CODES_DISABLE)
                private List<Integer> paSensitiveCodesDisable = null;




            public ProcessParamsRfid withPaSensitiveCodesDisable(List<Integer> paSensitiveCodesDisable) {
              this.paSensitiveCodesDisable = paSensitiveCodesDisable;
              return this;
            }

            public ProcessParamsRfid addPaSensitiveCodesDisableItem(Integer paSensitiveCodesDisableItem) {
                    if (this.paSensitiveCodesDisable == null) {
                    this.paSensitiveCodesDisable = new ArrayList<Integer>();
                    }
    ...
    **/
        ...
        public  List<Integer> getPaSensitiveCodesDisable() {
        return paSensitiveCodesDisable;
    }


            public void setPaSensitiveCodesDisable(List<Integer> paSensitiveCodesDisable) {
            this.paSensitiveCodesDisable = paSensitiveCodesDisable;
        }
...
sb.append("class ProcessParamsRfid {\n");
    sb.append("    paSensitiveCodesDisable: ").append(toIndentedString(paSensitiveCodesDisable)).append("\n");
sb.append("}");
return sb.toString();
}
