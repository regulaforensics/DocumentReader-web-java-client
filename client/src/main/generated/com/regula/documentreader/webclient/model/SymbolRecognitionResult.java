...
public class SymbolRecognitionResult {
  ...
  public SymbolRecognitionResult symbolRect(
      @javax.annotation.Nonnull RectangleCoordinates symbolRect) {
  ...
  public void setSymbolRect(@javax.annotation.Nonnull RectangleCoordinates symbolRect) {
    this.symbolRect = symbolRect;
  }
  ...
  static {
    ...
    openapiRequiredFields.add("SymbolRect");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    // validate the required field `SymbolRect`
