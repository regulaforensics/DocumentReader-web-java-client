...
public class TextField {
        ...
        @SerializedName(SERIALIZED_NAME_COMPARISON_LIST)
                private List<CrossSourceValueComparison> comparisonList = new ArrayList<CrossSourceValueComparison>();
    ...
    **/
        ...
        return lcid;
            ...
            public TextField withLcidName(String lcidName) {
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fieldType, fieldName, lcid, lcidName, status, validityStatus, comparisonStatus, value, valueList, validityList, comparisonList);
    }
