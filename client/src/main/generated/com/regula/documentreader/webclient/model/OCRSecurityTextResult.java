...
import com.regula.documentreader.webclient.model.OCRSecurityTextResultAllOf;
...
public class OCRSecurityTextResult {
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, elementResult, elementDiagnose, percentValue, criticalFlag, lightType, fieldRect, etalonResultType, etalonFieldType, etalonLightType, etalonFieldRect, securityTextResultOCR, etalonResultOCR, reserved1, reserved2);
    }
