...
public class VerifiedFieldMap {
  ...
  @javax.annotation.Nonnull
  private List<VerificationResult> matrix = new ArrayList<>();
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!VerifiedFieldMap.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `VerifiedFieldMap` properties. JSON: %s",
