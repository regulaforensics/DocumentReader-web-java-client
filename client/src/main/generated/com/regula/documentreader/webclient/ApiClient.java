...
import com.regula.documentreader.webclient.auth.ApiKeyAuth;
import com.regula.documentreader.webclient.auth.Authentication;
import com.regula.documentreader.webclient.auth.HttpBasicAuth;
import java.io.File;
...
public class ApiClient {
      ...
      new ArrayList<ServerConfiguration>(
          Arrays.asList(
              new ServerConfiguration(
                  ...
                  "Latest stable Regula Document Reader demo endpoint",
                  new HashMap<String, ServerVariable>()),
              new ServerConfiguration(
                  "https://nightly-api.regulaforensics.com",
   ...
   * @return a {@link com.regula.documentreader.webclient.ApiClient} object
   */
   ...
   */
  public void setAWS4Configuration(
      String accessKey, String secretKey, String sessionToken, String region, String service) {
    throw new RuntimeException("No AWS4 authentication configured!");
  }
   ...
   * @throws com.regula.documentreader.webclient.ApiException If fail to deserialize response body,
   ...
   * @throws com.regula.documentreader.webclient.ApiException If fail to read file content from
   ...
   * @throws com.regula.documentreader.webclient.ApiException If fail to execute the call
   */
   ...
   * @param returnType Return type
   * @return Type
   * @throws com.regula.documentreader.webclient.ApiException If the response has an unsuccessful
   ...
   * @param uri URI
   * @throws com.regula.documentreader.webclient.ApiException If fails to update the parameters
   */
