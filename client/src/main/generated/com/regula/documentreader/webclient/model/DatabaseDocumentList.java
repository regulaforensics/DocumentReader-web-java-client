...
public class DatabaseDocumentList {
  ...
  private List<DatabaseDocument> items;

  public DatabaseDocumentList() {}

  public DatabaseDocumentList items(@javax.annotation.Nonnull List<DatabaseDocument> items) {
    this.items = items;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public List<DatabaseDocument> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<DatabaseDocument> items) {
    this.items = items;
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DatabaseDocumentList> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(DatabaseDocumentList.class));

      return (TypeAdapter<T>)
          new TypeAdapter<DatabaseDocumentList>() {
            @Override
