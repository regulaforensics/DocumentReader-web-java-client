...
import com.regula.documentreader.webclient.model.PhotoIdentResultAllOf;
import com.regula.documentreader.webclient.model.RawImageContainerList;
...
public class PhotoIdentResult {
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, elementResult, elementDiagnose, percentValue, lightIndex, area, sourceImage, resultImages, fieldTypesCount, fieldTypesList, step, angle, reserved1, reserved2, reserved3);
    }
