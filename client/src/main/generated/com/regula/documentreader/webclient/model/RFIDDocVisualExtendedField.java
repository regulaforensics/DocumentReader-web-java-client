...
public class RFIDDocVisualExtendedField extends VisualExtendedFieldItem {
  ...
  public RFIDDocVisualExtendedField() {}

  public RFIDDocVisualExtendedField originDG(@javax.annotation.Nonnull Integer originDG) {
  ...
  public RFIDDocVisualExtendedField originDGTag(@javax.annotation.Nullable Integer originDGTag) {
  ...
  public RFIDDocVisualExtendedField originTagEntry(
  ...
  public RFIDDocVisualExtendedField originEntryView(
  ...
  public boolean equals(Object o) {
    ...
    RFIDDocVisualExtendedField rfIDDocVisualExtendedField = (RFIDDocVisualExtendedField) o;
    return Objects.equals(this.originDG, rfIDDocVisualExtendedField.originDG)
        && Objects.equals(this.originDGTag, rfIDDocVisualExtendedField.originDGTag)
        && Objects.equals(this.originTagEntry, rfIDDocVisualExtendedField.originTagEntry)
        && Objects.equals(this.originEntryView, rfIDDocVisualExtendedField.originEntryView)
        && super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(originDG, originDGTag, originTagEntry, originEntryView, super.hashCode());
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RFIDDocVisualExtendedField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!RFIDDocVisualExtendedField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `RFIDDocVisualExtendedField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!RFIDDocVisualExtendedField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'RFIDDocVisualExtendedField' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<RFIDDocVisualExtendedField> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(RFIDDocVisualExtendedField.class));

      return (TypeAdapter<T>)
          new TypeAdapter<RFIDDocVisualExtendedField>() {
            @Override
            public void write(JsonWriter out, RFIDDocVisualExtendedField value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public RFIDDocVisualExtendedField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RFIDDocVisualExtendedField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RFIDDocVisualExtendedField
   * @throws IOException if the JSON string is invalid with respect to RFIDDocVisualExtendedField
   */
  public static RFIDDocVisualExtendedField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RFIDDocVisualExtendedField.class);
  }

  /**
   * Convert an instance of RFIDDocVisualExtendedField to an JSON string
   *
   * @return JSON string
   */
