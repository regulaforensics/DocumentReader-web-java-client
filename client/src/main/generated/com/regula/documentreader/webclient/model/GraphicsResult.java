...
public class GraphicsResult {
  ...
  public GraphicsResult bufLength(@javax.annotation.Nullable Integer bufLength) {
  ...
  public GraphicsResult light(@javax.annotation.Nullable Integer light) {
    this.light = light;
    return this;
  }
  ...
  public GraphicsResult listIdx(@javax.annotation.Nullable Integer listIdx) {
  ...
  public GraphicsResult pageIdx(@javax.annotation.Nullable Integer pageIdx) {
  ...
  public GraphicsResult resultType(@javax.annotation.Nonnull Integer resultType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.docGraphicsInfo, graphicsResult.docGraphicsInfo)
        && Objects.equals(this.bufLength, graphicsResult.bufLength)
        && Objects.equals(this.light, graphicsResult.light)
        && Objects.equals(this.listIdx, graphicsResult.listIdx)
        && Objects.equals(this.pageIdx, graphicsResult.pageIdx)
        && Objects.equals(this.resultType, graphicsResult.resultType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(docGraphicsInfo, bufLength, light, listIdx, pageIdx, resultType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphicsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GraphicsResult.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GraphicsResult is not found in the empty JSON string",
                GraphicsResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GraphicsResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GraphicsResult` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : GraphicsResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GraphicsResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GraphicsResult' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<GraphicsResult> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(GraphicsResult.class));

      return (TypeAdapter<T>)
          new TypeAdapter<GraphicsResult>() {
            @Override
            public void write(JsonWriter out, GraphicsResult value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public GraphicsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GraphicsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphicsResult
   * @throws IOException if the JSON string is invalid with respect to GraphicsResult
   */
  public static GraphicsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphicsResult.class);
  }

  /**
   * Convert an instance of GraphicsResult to an JSON string
   *
   * @return JSON string
   */
