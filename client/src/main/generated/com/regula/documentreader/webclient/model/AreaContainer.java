...
public class AreaContainer {
  ...
  @javax.annotation.Nonnull
  private List<PointsContainer> points = new ArrayList<>();

  public AreaContainer() {}

  public AreaContainer count(@javax.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public void setPoints(@javax.annotation.Nonnull List<PointsContainer> points) {
    this.points = points;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AreaContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AreaContainer.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in AreaContainer is not found in the empty JSON string",
                AreaContainer.openapiRequiredFields.toString()));
      }
    }
    ...
    for (int i = 0; i < jsonArraypoints.size(); i++) {
      PointsContainer.validateJsonElement(jsonArraypoints.get(i));
    }
    ;
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!AreaContainer.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'AreaContainer' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<AreaContainer> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(AreaContainer.class));

      return (TypeAdapter<T>)
          new TypeAdapter<AreaContainer>() {
            @Override
            public void write(JsonWriter out, AreaContainer value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public AreaContainer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AreaContainer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AreaContainer
   * @throws IOException if the JSON string is invalid with respect to AreaContainer
   */
  public static AreaContainer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AreaContainer.class);
  }

  /**
   * Convert an instance of AreaContainer to an JSON string
   *
   * @return JSON string
   */
