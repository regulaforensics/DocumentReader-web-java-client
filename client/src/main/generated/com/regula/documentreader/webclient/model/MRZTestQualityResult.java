...
public class MRZTestQualityResult extends ResultItem {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mrZTestQuality, super.hashCode());
  }
  ...
  static {
    ...
    openapiFields =
        new HashSet<String>(
            Arrays.asList(
                "buf_length", "light", "list_idx", "page_idx", "result_type", "MRZTestQuality"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("MRZTestQuality", "result_type"));
  }
