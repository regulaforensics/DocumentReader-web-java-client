...
public class InData {
  ...
  public InData withImages(List<List> images) {
    this.images = images;
    return this;
  }

  public InData addImagesItem(List<ImagesFieldValue> imagesItem) {
    if (this.images == null) {
  ...
  public void setImages(List<List> images) {
    this.images = images;
  }
