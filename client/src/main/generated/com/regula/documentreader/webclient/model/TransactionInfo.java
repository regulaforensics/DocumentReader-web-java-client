...
public class TransactionInfo {
  ...
  @javax.annotation.Nullable
  private TransactionInfoDocumentsDatabase documentsDatabase;
  ...
  public TransactionInfo documentsDatabase(
      @javax.annotation.Nullable TransactionInfoDocumentsDatabase documentsDatabase) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionInfoDocumentsDatabase getDocumentsDatabase() {
    return documentsDatabase;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TransactionInfo.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `TransactionInfo` properties. JSON: %s",
    ...
    if (jsonObj.get("DocumentsDatabase") != null
      ...
      TransactionInfoDocumentsDatabase.validateJsonElement(jsonObj.get("DocumentsDatabase"));
    }
