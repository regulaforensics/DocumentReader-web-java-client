...
public class ImageQualityListResult {
  ...
  public ImageQualityListResult withResult(Integer result) {
    this.result = result;
    return this;
  }
  ...
  public ImageQualityListResult withList(List<ImageQualityCheck> list) {
    this.list = list;
    return this;
  }

  public ImageQualityListResult addListItem(ImageQualityCheck listItem) {
    if (this.list == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.result, imageQualityListResult.result)
        && Objects.equals(this.list, imageQualityListResult.list);
  }
