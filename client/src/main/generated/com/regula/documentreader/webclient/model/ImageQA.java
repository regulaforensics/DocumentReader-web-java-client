...
public class ImageQA {
  ...
  private BigDecimal dpiThreshold = 150d;

  public static final String SERIALIZED_NAME_ANGLE_THRESHOLD = "angleThreshold";

  @SerializedName(SERIALIZED_NAME_ANGLE_THRESHOLD)
  private BigDecimal angleThreshold = 5d;

  public ImageQA withDpiThreshold(BigDecimal dpiThreshold) {
  ...
  public BigDecimal getDpiThreshold() {
    return dpiThreshold;
  }

  public void setDpiThreshold(BigDecimal dpiThreshold) {
    this.dpiThreshold = dpiThreshold;
  }

  public ImageQA withAngleThreshold(BigDecimal angleThreshold) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getAngleThreshold() {
    return angleThreshold;
  }

  public void setAngleThreshold(BigDecimal angleThreshold) {
    this.angleThreshold = angleThreshold;
  }
