...
public class LexicalAnalysisResult {
  ...
  public LexicalAnalysisResult listVerifiedFields(
  ...
  public LexicalAnalysisResult bufLength(@javax.annotation.Nullable Integer bufLength) {
  ...
  public LexicalAnalysisResult light(@javax.annotation.Nullable Integer light) {
    this.light = light;
    return this;
  }
  ...
  public LexicalAnalysisResult listIdx(@javax.annotation.Nullable Integer listIdx) {
  ...
  public LexicalAnalysisResult pageIdx(@javax.annotation.Nullable Integer pageIdx) {
  ...
  public LexicalAnalysisResult resultType(@javax.annotation.Nonnull Integer resultType) {
  ...
  static {
    ...
    openapiFields.add("ListVerifiedFields");
    ...
    openapiRequiredFields.add("ListVerifiedFields");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LexicalAnalysisResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!LexicalAnalysisResult.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in LexicalAnalysisResult is not found in the empty JSON string",
                LexicalAnalysisResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!LexicalAnalysisResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `LexicalAnalysisResult` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : LexicalAnalysisResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!LexicalAnalysisResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'LexicalAnalysisResult' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<LexicalAnalysisResult> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(LexicalAnalysisResult.class));

      return (TypeAdapter<T>)
          new TypeAdapter<LexicalAnalysisResult>() {
            @Override
            public void write(JsonWriter out, LexicalAnalysisResult value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public LexicalAnalysisResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LexicalAnalysisResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LexicalAnalysisResult
   * @throws IOException if the JSON string is invalid with respect to LexicalAnalysisResult
   */
  public static LexicalAnalysisResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LexicalAnalysisResult.class);
  }

  /**
   * Convert an instance of LexicalAnalysisResult to an JSON string
   *
   * @return JSON string
   */
