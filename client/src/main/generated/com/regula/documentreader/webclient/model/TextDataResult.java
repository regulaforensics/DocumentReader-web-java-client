...
public class TextDataResult {
  ...
  public TextDataResult bufLength(@javax.annotation.Nullable Integer bufLength) {
  ...
  public TextDataResult light(@javax.annotation.Nullable Integer light) {
    this.light = light;
    return this;
  }
  ...
  public TextDataResult listIdx(@javax.annotation.Nullable Integer listIdx) {
  ...
  public TextDataResult pageIdx(@javax.annotation.Nullable Integer pageIdx) {
  ...
  public TextDataResult resultType(@javax.annotation.Nonnull Integer resultType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.docVisualExtendedInfo, textDataResult.docVisualExtendedInfo)
        && Objects.equals(this.bufLength, textDataResult.bufLength)
        && Objects.equals(this.light, textDataResult.light)
        && Objects.equals(this.listIdx, textDataResult.listIdx)
        && Objects.equals(this.pageIdx, textDataResult.pageIdx)
        && Objects.equals(this.resultType, textDataResult.resultType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(docVisualExtendedInfo, bufLength, light, listIdx, pageIdx, resultType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextDataResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TextDataResult.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in TextDataResult is not found in the empty JSON string",
                TextDataResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TextDataResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `TextDataResult` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : TextDataResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!TextDataResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'TextDataResult' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<TextDataResult> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(TextDataResult.class));

      return (TypeAdapter<T>)
          new TypeAdapter<TextDataResult>() {
            @Override
            public void write(JsonWriter out, TextDataResult value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public TextDataResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextDataResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextDataResult
   * @throws IOException if the JSON string is invalid with respect to TextDataResult
   */
  public static TextDataResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextDataResult.class);
  }

  /**
   * Convert an instance of TextDataResult to an JSON string
   *
   * @return JSON string
   */
