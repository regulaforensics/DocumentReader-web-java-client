...
public class SymbolCandidate {
  ...
  static {
    ...
    openapiFields =
        new HashSet<String>(Arrays.asList("SymbolCode", "SymbolProbability", "Class", "SubClass"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("SymbolCode", "SymbolProbability"));
  }
