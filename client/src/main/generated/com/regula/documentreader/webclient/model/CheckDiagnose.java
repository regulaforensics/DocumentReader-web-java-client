...
public class CheckDiagnose {
  ...
  public static final int SCREEN_CAPTURE_DETECTED = 191;

  public static final int ELECTRONIC_DEVICE_DETECTED = 192;
  ...
  public static final int WRONG_SYMBOL_BACKGROUND = 200;

  public static final int WRONG_BACKGROUND = 201;

  public static final int WRONG_MRZ_WIDTH = 202;

  public static final int WRONG_MRZ_HEIGHT = 203;
