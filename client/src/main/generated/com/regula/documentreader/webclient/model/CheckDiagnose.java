...
/**
 * Enumeration contains identifiers which determinate the single document element authenticity check
 * outcome reason:
 * https://docs.regulaforensics.com/develop/doc-reader-sdk/web-service/development/enums/check-diagnose/
 */
@JsonAdapter(CheckDiagnose.Adapter.class)
public enum CheckDiagnose {
  ...
  public static CheckDiagnose fromValue(Integer value) {
    for (CheckDiagnose b : CheckDiagnose.values()) {
  ...
  public static class Adapter extends TypeAdapter<CheckDiagnose> {
    @Override
    public void write(final JsonWriter jsonWriter, final CheckDiagnose enumeration)
        throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CheckDiagnose read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return CheckDiagnose.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    Integer value = jsonElement.getAsInt();
    CheckDiagnose.fromValue(value);
  }
}
