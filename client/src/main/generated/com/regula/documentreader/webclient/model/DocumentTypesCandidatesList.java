...
public class DocumentTypesCandidatesList {
  ...
  public DocumentTypesCandidatesList recResult(
  ...
  public DocumentTypesCandidatesList candidates(
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentTypesCandidatesList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DocumentTypesCandidatesList.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in DocumentTypesCandidatesList is not found in the empty JSON string",
                DocumentTypesCandidatesList.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DocumentTypesCandidatesList.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `DocumentTypesCandidatesList` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!DocumentTypesCandidatesList.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'DocumentTypesCandidatesList' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<DocumentTypesCandidatesList> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(DocumentTypesCandidatesList.class));

      return (TypeAdapter<T>)
          new TypeAdapter<DocumentTypesCandidatesList>() {
            @Override
            public void write(JsonWriter out, DocumentTypesCandidatesList value)
                throws IOException {
            ...
            @Override
            public DocumentTypesCandidatesList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentTypesCandidatesList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentTypesCandidatesList
   * @throws IOException if the JSON string is invalid with respect to DocumentTypesCandidatesList
   */
  public static DocumentTypesCandidatesList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentTypesCandidatesList.class);
  }

  /**
   * Convert an instance of DocumentTypesCandidatesList to an JSON string
   *
   * @return JSON string
   */
