...
public class JSON {
  ...
  public static Map<String, Class> childOfDocumentBinaryInfoResultByDiscriminatorValue =
      new HashMap<String, Class>();
  ...
  static {
    ...
    childOfDocumentBinaryInfoResultByDiscriminatorValue.put(
        "8", DocumentTypesCandidatesResult.class);
    ...
    childOfDocumentBinaryInfoResultByDiscriminatorValue.put(
        "DocumentBinaryInfoResult", DocumentBinaryInfoResult.class);
  }
  ...
  static {
    ...
    childOfDocumentTypesCandidatesResultByDiscriminatorValue.put(
        "104", DocumentBinaryInfoResult.class);
    ...
    childOfDocumentTypesCandidatesResultByDiscriminatorValue.put(
        "61", DocumentPositionResult.class);
    childOfDocumentTypesCandidatesResultByDiscriminatorValue.put(
        "62", DocumentPositionResult.class);
    childOfDocumentTypesCandidatesResultByDiscriminatorValue.put(
        "8", DocumentTypesCandidatesResult.class);
    childOfDocumentTypesCandidatesResultByDiscriminatorValue.put(
  ...
  public static GsonBuilder createGson() {
    GsonFireBuilder fireBuilder =
        new GsonFireBuilder()
            ...
            .registerTypeSelector(
                DocumentBinaryInfoResult.class,
                new TypeSelector() {
                  @Override
                  public Class getClassForElement(JsonElement readElement) {
                    return getClassByDiscriminator(
