...
public class JSON {
      ...
      return new TypeAdapter<T>() {
        ...
        public T read(JsonReader in) throws IOException {
          try {
            ...
            System.err.println(
                "Warning: failed to parse field of type "
            ...
            if (ResultItem.class.isAssignableFrom(type.getRawType())) {
              try {
                return (T) type.getRawType().getDeclaredConstructor().newInstance();
              } catch (Exception ex) {
                return null;
              }
            }
  ...
  static {
    ...
    gsonBuilder.registerTypeAdapterFactory(
        new com.regula.documentreader.webclient.model.DeviceInfoDocumentsDatabase
            .CustomTypeAdapterFactory());
    gsonBuilder.registerTypeAdapterFactory(
