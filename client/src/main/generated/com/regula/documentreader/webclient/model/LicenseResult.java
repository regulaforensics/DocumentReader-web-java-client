...
public class LicenseResult {
  ...
  public LicenseResult license(@javax.annotation.Nonnull byte[] license) {
  ...
  public LicenseResult bufLength(@javax.annotation.Nullable Integer bufLength) {
  ...
  public LicenseResult light(@javax.annotation.Nullable Integer light) {
    this.light = light;
    return this;
  }
  ...
  public LicenseResult listIdx(@javax.annotation.Nullable Integer listIdx) {
  ...
  public LicenseResult pageIdx(@javax.annotation.Nullable Integer pageIdx) {
  ...
  public LicenseResult resultType(@javax.annotation.Nonnull Integer resultType) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to LicenseResult
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!LicenseResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'LicenseResult' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<LicenseResult> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(LicenseResult.class));

      return (TypeAdapter<T>)
          new TypeAdapter<LicenseResult>() {
            @Override
            public void write(JsonWriter out, LicenseResult value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public LicenseResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LicenseResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LicenseResult
   * @throws IOException if the JSON string is invalid with respect to LicenseResult
   */
  public static LicenseResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LicenseResult.class);
  }

  /**
   * Convert an instance of LicenseResult to an JSON string
   *
   * @return JSON string
   */
